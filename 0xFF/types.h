...
static	 	PromoteTypes[9]			= {0, KnightFlag, BishopFlag, 0, 
...
#define MOVE_GET_FROM(move)		 			((move & (0b11111111 <<  0)) >>  0)
#define MOVE_GET_TO(move) 					((move & (0b11111111 <<  8)) >>  8)
#define MOVE_GET_CAPTURE_TYPE(move) ((move & (0b11111111 << 16)) >> 16)
#define MOVE_GET_CASTLE_FLAGS(move) ((move & (0b00001111 << 28)) >> 25)
